    ...
    <header>
        ...
        <ul class="nav-bar">
            <?php if (isset($_SESSION['id'])): ?>
                ...
                <li><a href="#"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;<?=$_SESSION['username']?>&nbsp;<i class="fa fa-chevron-down" aria-hidden="true" style="font-size: 15px"></i></a>
                
                    <ul>
                    <?php if ($_SESSION['admin']):?>    
                        <li><a href="<?=site_url('admin/dashboard')?>">Dashboard</a></li>
                    <?php endif;?>
                        <li><a href="<?=site_url('students/account/'.$_SESSION['id'])?>">Account</a></li>
